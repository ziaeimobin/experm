...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/ziaeimobin/experm/master/install.sh"
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/ziaeimobin/experm/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
